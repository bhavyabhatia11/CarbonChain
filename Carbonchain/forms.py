...
class SendMoneyForm(Form):
    ...
    product_id = StringField('Product ID', [validators.Length(min=1,max=50)])
    units = IntegerField('Number of Units', [validators.NumberRange(min =1,message="Alteast 1 Unit Required")], default=1)
